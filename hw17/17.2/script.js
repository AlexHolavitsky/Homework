// ДЗ 17.2. Клас "Тренер"
// Створіть клас Coach, який буде представляти тренера. Додайте властивості,
//  такі як ім'я, спеціалізація та рейтинг. Також реалізуйте метод для виведення
//   інформації про тренера та його рейтинг.
// class Coach {
//  // Ваш код тут
// }
